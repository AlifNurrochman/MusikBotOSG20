...
const { canModifyQueue, STAY_TIME } = require("../util/MusikBotUtil");

module.exports = {
  async play(song, message) {
    const { SOUNDCLOUD_CLIENT_ID } = require("../util/MusikBotUtil");
    ...
    try {
      var playingMessage = await queue.textChannel.send(`🎶 Memutar lagu: **${song.title}** ${song.url}`);
